        ...
        <div class="row container">
            ...
            <form action="banco_de_dados/create.php" method="post" class="col s12">
                <fieldset class="formulario" style="padding: 15px">
                    ...
                    <h5 class="light center">Cadastrar Aluno</h5>
                        ...
                        <h6 class="light center-align">Informações Pessoais</h6>
                            ...
                            <!--INFORMAÇÕES PESSOAIS-->   
                                ...
                                <!--CAMPO REGISTRO CBJ-->
                                    <div class="input-field col s12">
                                        ...
                                        <input type="tel" name="registro" id="registro" maxlenght="15">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <input type="tel" name="cpf" id="cpf" maxlenght="11" required>
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <input type="date" name="nascimento" id="nascimento" maxlenght="10" required>
                            ...
                            <div class="input-field col s12">
                               <i class="material-icons md-light prefix">featured_video</i>
                                <input type="tel" name="rg" id="rg" maxlenght="9" required>
                            ...
                            <div class="input-field col s12">
                                ...
                                <input type="text" name="expedidor" id="expedidor" maxlenght="8" required>
                    ...
                    <div class="container">
                        ...
                        <h6 class="light center-align">Contato</h6>
                            ...
                            <div class="input-field col s12">
                                <i class="material-icons md-light prefix">phone</i>
                                <input type="tel" name="telefone2" id="telefone2" maxlenght="15">
                            ...
                            <fieldset class="formulario" style="padding: 15px">
                                <!--CAMPO RUA-->
                                    <div class="input-field col s12">
                                       ...
                                       <input type="text" name="rua" id="rua" maxlenght="50" required>
                                       <label for="rua">Rua</label>
                                    </div>  
                                <!--CAMPO NUMERO-->
                                    <div class="input-field col s12">
                                        <i class="material-icons md-light prefix">local_convenience_store</i>
                                        <input type="number" name="numero" id="numero" min="1" max="5500" maxlenght="4" required>
                                        <label for="num">Número do Local</label>
                                    </div>
                                <!--CAMPO BAIRRO-->
                                    <div class="input-field col s12">
                                        <i class="material-icons md-light prefix">location_city</i>
                                        <input type="text" name="bairro" id="bairro" maxlenght="35" required>
                                        <label for="bairro">Bairro</label>
                                    </div>
                                 <!--CAMPO CIDADE-->
                                    <div class="input-field col s12">
                                        <i class="material-icons md-light prefix">outlined_flag</i>
                                        <input type="text" name="cidade" id="cidade" maxlenght="35" required>
                                        <label for="cidade">Cidade</label>
                                    </div>
                                 <!--CAMPO ESTADO-->
                                    <div class="input-field col s12">
                                        <i class="material-icons md-light prefix">flag</i>
                                        <input type="text" name="estado" id="estado" maxlenght="35" required>
                                        <label for="estado">Estado</label>
                                    </div>
                                 <!--CAMPO CEP-->
                                    <div class="input-field col s12">
                                        <i class="material-icons md-light prefix">format_list_numbered</i>
                                        <input type="tel" name="cep" id="cep" maxlenght="8" required>
                        ...
                        <h6 class="light center-align">Associação Matricular</h6>
                            ...
                            <div class="input-field col s12">
                               <i class="material-icons md-light prefix">perm_identity</i>
                                <input type="text" name="professor" id="professor" maxlenght="60" required>
                                <label for="professor">Nome do Professor</label>
                            </div>
                            <!--CAMPO ENTIDADE-->
                            <div class="input-field col s12">
                                <i class="material-icons md-light prefix">school</i>
                                <input type="text" name="entidade" id="entidade" maxlenght="75" required>
                                <label for="entidade">Nome da Entidade</label>
                            </div>
                            <!--CAMPO FAIXAS-->
                            <div class="input-field col s12">
                                <i class="material-icons md-light prefix">sports_hockey</i>
                                <input type="text" name="faixa" id="faixa" maxlenght="20" required>
                                <label for="faixa">Cor da Faixa</label>
                            </div>
                            <!--CAMPO DATA DAS FAIXAS-->
                            <div class="input-field col s12">
                                <i class="material-icons md-light prefix">date_range</i>
                                <input type="date" name="datafaixa" id="datafaixa" maxlenght="10" required>
                    ...
                    <div class="container">
                        ...
                        <h6 class="light center-align">Observações</h6>
                            <fieldset class="formulario" style="padding: 15px">
                                ...
                                <textarea id="observacoes" name="observacoes" rows="10" cols="30" placeholder="Digite aqui informações adicionais relevantes... "></textarea>
                                </form>
                    </div>
                    <!--BOTÕES-->
                    <div class="input-field col s12" id="centralizar">
                        <p>&nbsp;</p>
                        <input type="submit" value="cadastrar" class="btn black" style="border: 1px solid greenyellow; border-radius: 10px; margin: 18px;">
                        <input type="reset" value="limpar" class="btn black" style="border: 1px solid red; border-radius: 10px; margin: 18px;">
                    </div>
                </fieldset>
            </form>
        </div>
